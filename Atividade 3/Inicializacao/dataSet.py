...
def criaMatrizAdjacencias(instancia):
    ...
    caminho = 'C:/Users/Pronu/Documents/4º Semestre/Grafos/Atividade 3/Instancias/' + instancia + '.txt'
...
def salvaResultado(resultado):
    ...
    for res in resultado:
        stringRes += str(res) + ' '
    arquivo = open('C:/Users/Pronu/Documents/4º Semestre/Grafos/Atividade 3/Resultados/resultado.txt', 'a+')
